...
meta <- data.frame(
  Title =  "Neural DroNc-seq" ,
  Description = "DroNc-seq subset of the set of four protocols sequenced on mouse cortex" ,
  BiocVersion="3.11",
  Genome="mm10",
  SourceType = "Zip",
  ...
  DispatchClass="Rds",
  RDataPath = "scSimBenchmarkData/Neural_DroNcseq.rds" ,
  stringsAsFactors = FALSE
)

write.csv( meta,  file="../extdata/metadata-Neural-DroNcseq.csv",    row.names=FALSE)
