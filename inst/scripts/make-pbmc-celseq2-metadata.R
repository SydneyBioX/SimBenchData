...
meta <- data.frame(
  Title =  "pbmc CEL-Seq2" ,
  Description = "CEL-Seq2 subset of the set of six protocols sequenced on human PBMC" ,
  BiocVersion="3.11",
  Genome="hg19",
  SourceType = "Zip",
  ...
  DispatchClass="Rds",
  RDataPath = "scSimBenchmarkData/PBMC_celseq2.rds" ,
  stringsAsFactors = FALSE
)

write.csv( meta,  file="../extdata/metadata-PBMC-CELSeq2.csv",    row.names=FALSE)
