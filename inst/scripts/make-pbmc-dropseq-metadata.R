...
meta <- data.frame(
  Title =  "pbmc Drop-seq" ,
  Description = "Drop-seq subset of the set of six protocols sequenced on human PBMC" ,
  BiocVersion="3.13",
  Genome="hg19",
  SourceType = "Zip",
  ...
  DispatchClass="Rds",
  RDataPath = "scSimBenchmarkData/PBMC_Dropseq.rds" ,
  stringsAsFactors = FALSE
)

write.csv( meta,  file="../extdata/metadata-PBMC-Dropseq.csv",    row.names=FALSE)
