...
meta <- data.frame(
  Title =  "Dong intest" ,
  Description = "Intestine cells of E9.5 to E11.5 mouse embryos" ,
  BiocVersion="3.11",
  Genome="mm10",
  SourceType = "XLS/XLSX",
  ...
  DispatchClass="Rds",
  RDataPath = "scSimBenchmarkData/Dong_mouse_intestine.rds" ,
  stringsAsFactors = FALSE
)

write.csv( meta,  file="../extdata/metadata-Dong-mouse-intest.csv",    row.names=FALSE)
