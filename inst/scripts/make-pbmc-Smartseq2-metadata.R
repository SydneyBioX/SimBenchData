...
meta <- data.frame(
  Title =  "pbmc Smart-seq2" ,
  Description = "Smart-seq2 subset of the set of six protocols sequenced on human PBMC" ,
  BiocVersion="3.11",
  Genome="hg19",
  SourceType = "Zip",
  ...
  DispatchClass="Rds",
  RDataPath = "scSimBenchmarkData/PBMC_smartseq2.rds" ,
  stringsAsFactors = FALSE
)

write.csv( meta,  file="../extdata/metadata-PBMC-smartseq2.csv",    row.names=FALSE)
