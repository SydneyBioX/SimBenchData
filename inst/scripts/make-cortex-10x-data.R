...
cell_name <- fread(paste0(rootDir ,"/cell.names.new.txt"), header = TRUE)
gene_name <- fread(paste0(rootDir ,"/genes.count.txt"), header = TRUE)
...
saveRDS(count,  "cortex_10x_cpm.rds")
