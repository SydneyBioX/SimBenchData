...
cell_name <- fread(paste0(rootDir , "/cells.read.new.txt"), header = FALSE)
gene_name <- fread(paste0(rootDir , "/genes.read.txt"), header = FALSE)
...
saveRDS(count,  "PBMC_Smartseq2_cpm.rds")
